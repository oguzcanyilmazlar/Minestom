...
public record ClientChatMessagePacket(@NotNull String message, @NotNull MessageSignature signature,
    ...
    public ClientChatMessagePacket(BinaryReader reader) {
        this(reader.readSizedString(256), new MessageSignature(null, reader),
                reader.readBoolean());
    }
